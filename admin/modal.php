        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="logout_processing.php" class="btn btn-danger"><i class="fas fa-sign-out-alt"></i> Logout</a>
                </div>
...
<!-- Edit Profile -->
	...
	<?php
		$cq=mysqli_query($conn,"select * from customer left join `user` on user.user_id=customer.user_id where customer.user_id='".$_SESSION['id']."'");
