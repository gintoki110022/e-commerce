...
?>
        ...
        <div class='product product-item-background'>
            <div class="slick-product-img">
                <a href="detail-<?php echo str_replace(" ","-",$row['product_name']); ?>-<?php echo $row['product_id']; ?>.html">
                ...
                <div class='product-body'>
                    ...
                    <?php } else {?>
                        <h4 class='product-price header-cart-item-info' style='min-height:54px;line-height:54px;'><strong><?php echo number_format($row['product_price'], 2) ; ?></strong> VND</h4>
                    <?php } ?>
